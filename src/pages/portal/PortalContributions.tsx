      ...
      <div className="bg-gradient-to-br from-church-blue to-church-blue/90 p-6 md:p-10 rounded-[32px] md:rounded-[48px] text-white shadow-2xl shadow-church-blue/30 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <p className="text-sm md:text-base leading-relaxed mb-6 md:mb-8 text-white/80">
            We appreciate your faithful generosity. Please make your contributions through any of the following methods at our Church Accounts Office.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
            <div className="bg-white/10 backdrop-blur-sm p-4 md:p-5 rounded-2xl md:rounded-3xl border border-white/10 hover:bg-white/15 transition-all">
              <div className="flex items-center gap-3 mb-2 md:mb-3">
                <Banknote className="w-4 h-4 md:w-5 md:h-5 text-church-yellow" />
                <h5 className="font-bold text-sm md:text-base text-church-yellow">Tithes & Offerings</h5>
              </div>
              <p className="text-xs md:text-sm text-white/70 leading-relaxed">Weekly tithes and special offerings during Sunday services or at the accounts office.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-4 md:p-5 rounded-2xl md:rounded-3xl border border-white/10 hover:bg-white/15 transition-all">
              <div className="flex items-center gap-3 mb-2 md:mb-3">
                <Church className="w-4 h-4 md:w-5 md:h-5 text-church-yellow" />
                <h5 className="font-bold text-sm md:text-base text-church-yellow">Building Fund</h5>
              </div>
              <p className="text-xs md:text-sm text-white/70 leading-relaxed">Support church development, expansion projects, and infrastructure improvements.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-4 md:p-5 rounded-2xl md:rounded-3xl border border-white/10 hover:bg-white/15 transition-all">
              <div className="flex items-center gap-3 mb-2 md:mb-3">
                <ArrowUpRight className="w-4 h-4 md:w-5 md:h-5 text-church-yellow" />
                <h5 className="font-bold text-sm md:text-base text-church-yellow">Mission Support</h5>
              </div>
              <p className="text-xs md:text-sm text-white/70 leading-relaxed">Fund outreach programs, missionary work, and community evangelism efforts.</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-4 md:p-5 rounded-2xl md:rounded-3xl border border-white/10 hover:bg-white/15 transition-all">
              <div className="flex items-center gap-3 mb-2 md:mb-3">
                <CreditCard className="w-4 h-4 md:w-5 md:h-5 text-church-yellow" />
                <h5 className="font-bold text-sm md:text-base text-church-yellow">Special Projects</h5>
              </div>
              <p className="text-xs md:text-sm text-white/70 leading-relaxed">Contribute to specific church programs, events, and charitable initiatives.</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white p-6 md:p-10 rounded-[32px] md:rounded-[48px] border-2 border-church-yellow/30 shadow-xl shadow-church-blue/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          ...
          <div className="bg-church-soft p-5 md:p-6 rounded-2xl md:rounded-3xl text-center">
            ...
            <h5 className="font-bold text-sm md:text-base text-church-black mb-1">Accepted Methods</h5>
            <p className="text-xs md:text-sm text-church-gray">Cash, Mobile Money<br />& Bank Transfers</p>
          </div>

...
export default function PrayerRequests() {
  ...
  const handleExport = () => {
    downloadExcel(requests, `graceflow_prayer_requests_${new Date().toISOString().split('T')[0]}.xlsx`);
  };
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">Review, respond, and track member prayer needs.</p>
        </div>
